        ...
        foreach ($this->catalogue() as $row) {
            $property = Property::updateOrCreate(
                ...
                [
                    ...
                    'base_nightly_cents' => $row['base_nightly_cents'],
