 ...
 *
 * Coverage targets every audience and the most common questions:
 *   - Basics: what Vaytoven is / which of the two services applies to you
 *   - Offers: how to submit one / what an acceptance means / who handles refunds
 *   - Hosting: the 30-day subscription / protecting yourself / listing standards
 *   - Members: the 180-day program / eligible clubs / how members get paid
 */
class HelpArticleSeeder extends Seeder
{
    ...
    private function articles(): array
    {
        return [
            ...
            [
                'slug'     => 'host-subscription-or-member-program',
                'audience' => HelpAudience::All->value,
                'category' => 'basics',
                'title'    => 'Member program or host subscription: which applies to me?',
                'summary'  => 'Two separate services. Members pay once for a 180-day managed program; hosts pay a recurring 30-day subscription and manage their own listings.',
                'body'     => "Vaytoven has two services. You are on one or the other — they are not tiers of the same plan, and they are not billed the same way.\n\n180-DAY MEMBER MANAGED LISTING PROGRAM\nMembers pay a one-time fee for Vaytoven to provide managed listing and advertising services during the 180-day program. Over that period we assist with the listing, keep the advertisement running on the platform, and market the Vaytoven platform to generate public exposure for participating listings.\n\nIt is NOT a recurring subscription. You pay once, for the 180-day program, and it does not bill again.\n\nHOST 30-DAY SUBSCRIPTION\nHosts pay a recurring 30-day subscription for access to our SaaS platform and dashboard. Under this option you are responsible for creating and managing your own listings. Vaytoven provides the software platform, listing functionality, exposure, and the tools you use to communicate with interested travelers.\n\nIt renews every 30 days from the day it starts, until you cancel. That is a 30-day cycle rather than a calendar month, so the renewal date will not sit on the same day of each month.\n\nWHAT IS THE SAME UNDER BOTH\nVaytoven advertises, and nothing more. Travelers submit offers, you accept or decline, and if you accept you settle the stay and the payment with the guest directly. Vaytoven takes no percentage of what you earn under either service.",
                'search_keywords' => 'subscription, 30 day, monthly, one-time, 180 day, program, member, host, pricing, cost, plan, difference, renew, billing',
            ],
            ...
            [
                ...
                'summary'  => 'Submit your details, start a recurring 30-day subscription, then create and manage your listings from your dashboard.',
                'body'     => "Submit your details at /host/onboarding, or use the host enquiry button on the home page. We screen for property type, location, and ownership before onboarding.\n\nHosting runs on a recurring 30-day subscription giving you access to our SaaS platform and dashboard: the listing tools, the exposure, and the tools you use to communicate with interested travelers. It renews every 30 days from the day it starts, until you cancel.\n\nUnder this option YOU are responsible for creating and managing your own listings — the photos, the copy, the rates and the availability are yours to set and keep current.\n\nIf you would rather we did that work for you, the 180-Day Member Managed Listing Program is the other service: a one-time fee rather than a recurring subscription. See \"Member program or host subscription\".\n\nOnce your listing is live, travelers submit offers on your dates, which you accept or decline from your dashboard. If you accept, you arrange the stay and payment with the guest directly.\n\nVaytoven charges you for platform access and advertising, and never asks for banking details, government ID or tax forms.",
            ...
            [
                ...
                'summary'  => 'A one-time fee for a 180-day managed advertising term. Not a subscription. Guests pay you directly.',
                'body'     => "The Managed Listing Program is designed for owners of points-based vacation property — Marriott, Hilton, Disney, Wyndham, RCI, Interval — who don't use every week they're entitled to.\n\nA specialist contacts you within one business day of your enquiry. We confirm your program rules, audit which weeks are eligible to advertise, and quote the cost. We then assist with building the listing, keep the advertisement running on the platform, and market Vaytoven itself to generate public exposure for participating listings.\n\nThe program is a ONE-TIME fee covering a 180-day managed advertising and listing term. It is not a recurring subscription and it does not bill again. We quote the exact figure for your specific portfolio before you commit to anything.\n\nThat fee is the only amount Vaytoven charges you, and it is the only money that moves through Vaytoven. When a traveler makes an offer you accept, the guest pays you directly and you agree the terms with them. Vaytoven does not hold funds in escrow, does not take a percentage of what you earn, and does not pay you out.\n\nIf you would rather build and manage your own listing, the Host 30-Day Subscription is the other service — see \"Member program or host subscription\".\n\nYou remain responsible for confirming that renting your weeks is permitted under your club's rules.",
            ...
            [
                ...
                'body'     => "The same way hosts do: the guest pays you directly. Vaytoven advertises your unused weeks — it does not rent them, take a reservation, hold funds in escrow, or pay you out.\n\nWhen a traveler submits an offer on one of your weeks, you see it on your member dashboard with the dates, party size, amount offered and when it expires. If you accept, you agree the payment and terms with the guest yourself.\n\nWhat you pay Vaytoven is separate and goes the other way: a one-time fee for the 180-day managed listing term, quoted in writing before you commit. It is the only amount Vaytoven charges you — there is no percentage of your rental income, and no recurring charge on the member program.\n\nVaytoven will never ask for your banking details, government ID or tax forms.",
