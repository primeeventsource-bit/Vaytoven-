    ...
    private function articles(): array
    {
        return [
            ...
            [
                ...
                'audience' => HelpAudience::All->value,
                'category' => 'basics',
                'title'    => 'Host subscription or member program: which applies to me?',
                'summary'  => 'Two separate options. Hosts pay monthly and manage their own listing; members pay once for a 180-day managed term.',
                'body'     => "Vaytoven offers two distinct services. You are on one or the other — they are not tiers of the same plan, and they are not billed the same way.\n\nHOST — MONTHLY SaaS SUBSCRIPTION\nHosts pay a monthly subscription fee for access to the Vaytoven platform. Under this option you create, maintain and manage your own property listing through your Vaytoven dashboard. Vaytoven provides the software platform, listing functionality, exposure, and the tools you use to communicate with interested travelers. It recurs monthly until you cancel.\n\nMEMBER — 180-DAY MANAGED LISTING PROGRAM\nMembers pay a one-time fee for a 180-day managed advertising and listing program. Over that term Vaytoven does more of the work for you: assisting with the listing, maintaining the advertisement on the platform, and marketing the Vaytoven platform to generate public exposure for participating listings.\n\nThe 180-day member program is NOT a monthly or annual recurring subscription. You pay once, for that term.\n\nWhat is identical under both: Vaytoven advertises, and nothing more. Travelers submit offers, you accept or decline, and if you accept you settle the stay and the payment with the guest directly. Vaytoven takes no percentage of what you earn under either option.",
                'search_keywords' => 'subscription, monthly, one-time, 180 day, program, member, host, pricing, cost, plan, difference',
            ],
            ...
            [
                ...
                'summary'  => 'Submit your details, start a monthly subscription, then build and manage your listing from your dashboard.',
                'body'     => "Submit your details at /host/onboarding, or use the host enquiry button on the home page. We screen for property type, location, and ownership before onboarding.\n\nHosting runs on a monthly SaaS subscription. It gives you access to the Vaytoven platform: the listing tools, the exposure, your dashboard, and the tools you use to communicate with interested travelers. Under this option YOU create, maintain and manage your own listing — the photos, the copy, the rates and the availability are yours to set and keep current.\n\nIf you would rather we did that work for you, the 180-day Managed Listing Program is the other option, and it is a one-time fee rather than a subscription. See \"Host subscription or member program\".\n\nOnce your listing is live, travelers submit offers on your dates, which you accept or decline from your dashboard. If you accept, you arrange the stay and payment with the guest directly.\n\nVaytoven charges you for platform access and advertising, and never asks for banking details, government ID or tax forms.",
